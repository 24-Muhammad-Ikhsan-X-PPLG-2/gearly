...
const Profile = () => {
    ...
    const { onClose, onOpen, show } = useModalLogout();
    return (
        <>
            <ModalLogout onClose={onClose} show={show} />
            <motion.main
                            ...
                            <div className="mt-6 space-y-4">
                                ...
                                <div className="rounded-4xl border border-slate-200 bg-slate-50 p-5">
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        <button
                                            onClick={onOpen}
                                            className="cursor-pointer rounded-3xl bg-slate-900 px-4 py-2 text-sm font-semibold text-nowrap text-white transition hover:bg-slate-800"
                                        >
                                            Sign out
                                        </button>
                                    </div>
